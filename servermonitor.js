 ...
 * once this script is installed, go to your terminal and type in the following
 * alias monitor=servermonitor.js
 * now you can type 
 * monitor [hostname]
 * to monitor said hostname.
 * test it with n00dles, foodnstuff, or anything.
 * only works with hosts you can hack
 * darkweb doesn't work.
 * <3
*/
